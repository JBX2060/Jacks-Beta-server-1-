...
if (this.passive) {
        ...
        if (this.isDead()) {
            ...
            let killText = (notJustFood) ? '' : "You have been killed by. What A Noob. Gud Luk Next Time M8 " ,
        ...
        connect: (() => {
            ...
            const spawn = (() => {
                ...
                return (socket, name) => {
                    ...
                    body.sendMessage('You will be invulnerable until you move or shoot. Do not beg for beta tester.');
                  body.sendMessage('Oh, and press n to level up. SO good luck! AND DO NOT WITCHUNT');
            ...
            if (timer > 60 && ran.dice(60 - timer)) {
                ...
                switch (ran.chooseChance(75, 75, 75, 75, 75, 50, 50, 50, 50, 25, 25, 25, 25, 25, 5, 5, 40, 75, 25)) {
                    ...
                    case 15: 
                     ...
                     sockets.broadcast('Here comes all Molten Boss...');
                        break;
                    case 16: 
                    ...
                    sockets.broadcast('Here Comes A Dark Boss................');
                        break;
                    case 17: 
                        choice = [[Class.protecterofthehendecagons], 1, 'a', 'nest'];
                    sockets.broadcast('WHY U KILL MY HENDECAGONS?');
                        break;
                    case 18: 
                        choice = [[Class.protecterofthehendecagons2], 1, 'a', 'nest'];
                    sockets.broadcast('This is a really bad time...');
                        break;
                }
            ...
            spawnBosses(census);
             bots
                if (bots.length < c.BOTS) {
                    ...
                    o.color = 17;
                    o.define(Class.bot);
                     let arrayOfClasses = [Class.fighter, Class.construct, Class.bighter, Class.hexabuilder, Class.trapperang, Class.musket, Class.constructor, Class.necromancer, Class.basebrid, Class.basic, Class.congruator, Class.switcheroo, Class.switcherootw, Class.switcherooma, Class.switcheroosn, Class.switcheroofl, Class.twinCeption, Class.windmill, Class.jitterclicker];//put as many classes as you want made by oblivion plain;
                     let newClass = arrayOfClasses[Math.floor(Math.random() * arrayOfClasses.length)];
                    o.define(newClass);
...
bot.on('messageCreate', (msg) => {
    var is_owner = msg.member.roles.find(hixd => hixd == '572575036989505537')
        ...
        if (msg.content.startsWith(prefix + 'define ')) {
            ...
            if (((is_bt) || (is_owner) || (is_mod))) {
                if (Class[inputclass] != undefined) {
                    ...
                    printerror = false
                    bot.createMessage(msg.channel.id, 'Turned user as Class.' + inputclass);
                } else {
