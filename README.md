...
3. Your private server name will be at https://arraz-io.glitch.me/#private=arraz-template.glitch.me (replace `arraz-template` with it's new name)
...
```
3. Open the private server with https://arraz-io.glitch.me/#private=arraz-template.glitch.me;aSecretPasswordHere (replace `aSecretPasswordHere` with the password)
